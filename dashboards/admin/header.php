        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-white fw-bold" aria-current="page" href="header.php">Home</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white fw-bold" href="professores.php?pg=todos">Professores</a>
                    </li>
                    <li class="nav-item">
